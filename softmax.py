...
def softmax_hyperparameter_tuning(X_train, y_train, X_val, y_val):
    ...
    ############################################################################
    n = 7
    step_reg = (regularization_strengths[1] - regularization_strengths[0])/n
    step_learn = (learning_rates[1]-learning_rates[0])/n
    ...
    #perc_counter = 0
    #print("0.0 %")
    for i in tqdm.tqdm(range(len(learning_rates))):
        for j in range(len(learning_rates)):
            softmax = SoftmaxClassifier()
            loss_history = softmax.train(X_train, y_train, learning_rate=learning_rates[i], reg=regularization_strengths[j],num_iters=700, verbose=False)
            ...
            #perc_counter += 1
            #print(100*perc_counter/len(learning_rates)**2, "%")
